...
export function Input({
  ...
  return (
    <label className="block">
      <div className="mb-1.5 flex flex-col gap-0.5 sm:mb-2 sm:gap-1 sm:flex-row sm:items-center sm:justify-between">
      ...
      <input
        className={cn(
          "w-full rounded-lg border bg-white px-3 py-1.5 sm:px-3.5 sm:py-2.5 text-xs sm:text-sm text-slate-900 outline-none transition",
